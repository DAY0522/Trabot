...
// functions
function Message(arg) {// 메세지 출력하는 함수
// arg는 text와 text 방향(User/Trabot)을 가지는 객체
    this.text = arg.text;
...
function sendMessage(text, message_side) { // 메세지 보내는 함수
...
function requestChat(messageText, url_pattern) { // 학습한 데이터를 통해 출력할 메세지를 만듦.
    $.ajax({
